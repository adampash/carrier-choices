const Results = {
  financing: {
    ...
    text: "You can make monthly payments to your carrier. Once you're done paying your phone off, you own it. You can only leave your carrier once your phone is paid off.",
  ...
  apple_lease: {
    ...
    text: "This year, Apple has introduced a new lease program that bypasses carriers entirely. You'll pay Apple a monthly fee, and, when a new iPhone comes out, you can trade in your old one to upgrade immediately. You won't get to keep your phone, but you'll always have the latest."
  }
}
